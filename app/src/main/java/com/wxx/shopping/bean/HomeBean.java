...
/**
 * 作者：Tangren_ on 2017/3/14 17:55.
...
public class HomeBean {
    ...
    public String toString() {
        return "HomeBean{" +
                "cpOne=" + cpOne.toString() +
                ", cpTwo=" + cpTwo.toString()  +
                ", cpThree=" + cpThree.toString()  +
                ", id=" + id +
                ", title='" + title + '\'' +
                ", campaignOne=" + campaignOne +
                ", campaignTwo=" + campaignTwo +
                ", campaignThree=" + campaignThree +
                '}';
    }
}
